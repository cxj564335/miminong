...
<!--            <td><input type="text" class="form-control" name="enroll" id="enroll" placeholder="请填写注册商"></td>-->
        ...
        <?php 
                ...
                $arr=$pdo->getAll("select * from mi_domain");
                //print_r($arr);
                foreach ($arr as $v ){
...
<!--            <td><input type="text" class="form-control" name="enroll" id="enroll"  placeholder="请填写注册商" value="<?php echo $v['enroll'];?>"></td>-->
            ...
            <td>
                <select  class="form-control" name="statu"> 
                    <option value="0" <?php echo $v['statu']==0?'selected = "selected"':''?>>未审核</option>
                    <option value="1" <?php echo $v['statu']==1?'selected = "selected"':''?>>已审核</option>
                </select>
            </td>
            <td>
                <select  class="form-control" name="sell"> 
            ...
            <td>
                <select  class="form-control" name="advert"> 
                    <option value="0" <?php echo $v['advert']==0?'selected = "selected"':''?>>不推送</option>
                    <option value="1" <?php echo $v['advert']==1?'selected = "selected"':''?>>精品</option>
                    <option value="2" <?php echo $v['advert']==2?'selected = "selected"':''?>>数字</option>
                
              </select>
            </td>
            <td>
                <input class="form-control" type="text" name="sort" value="<?php echo $v['sort'];?>"/>
            </td>
